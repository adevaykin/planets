...
//     ) -> GeometryPass {
//         let attachments =
//             GeometryPass::create_attachments(swapchain.format, swapchain.depth_format);
...
//             render_pass,
//             "basic",
//             size_def.get_size().width as u32,
//             size_def.get_size().height as u32,
//         )
...
//             debug_assert!(
//                 swapchain.images[i].views.len() == 1 && swapchain.depth_images[i].views.len() == 1
//             );
//             let attachment_views = vec![
//                 swapchain.images[i].views[0],
//                 swapchain.depth_images[i].views[0],
//             ];
...
//     ) {
//         let mut _debug_region =
//             debug::Region::new(&*self.device.borrow(), *command_buffer, self.label.as_str());
//
//         let clear_values = [
//             vk::ClearValue {
...
//                 device_ref.logical_device.cmd_begin_render_pass(
//                     *command_buffer,
...
//             self.draw_list.borrow_mut().draw(
//                 frame_num,
//                 DrawType::Opaque,
//                 &self.camera.borrow(),
//                 &light_manager_ref,
