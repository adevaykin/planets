...
impl Region {
    ...
    pub fn new(device: &Device, cmd_buffer: vk::CommandBuffer, label: &str) -> Option<Region> {
...
impl Object {
    #[cfg(debug_assertions)]
    pub fn label(device: &Device, obj_type: vk::ObjectType, ptr: u64, label: &str) {
        let full_label = match obj_type {
            vk::ObjectType::BUFFER => String::from("Buffer:") + label,
            vk::ObjectType::RENDER_PASS => String::from("RenderPass:") + label,
            vk::ObjectType::IMAGE => String::from("Image:") + label,
            vk::ObjectType::IMAGE_VIEW => String::from("ImageView:") + label,
            vk::ObjectType::SHADER_MODULE => String::from("Shader:") + label,
            vk::ObjectType::PIPELINE_LAYOUT => String::from("PipelineLayout:") + label,
            vk::ObjectType::PIPELINE => String::from("Pipeline:") + label,
            vk::ObjectType::SAMPLER => String::from("Sampler:") + label,
